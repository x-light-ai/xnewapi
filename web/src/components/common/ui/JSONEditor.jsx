...
const JSONEditor = ({
  ...
  // FORK-CUSTOM: Allow fork settings editors to document structured keys.
  keyDescriptions = {},
  ...props
}) => {
    ...
    return (
      <div className='space-y-1'>
        ...
        {keyValuePairs.map((pair, index) => {
          ...
          // FORK-CUSTOM: Render optional descriptions for fork-owned setting keys.
          const keyDescription = keyDescriptions?.[pair.key];
          ...
          // FORK-CUSTOM: Append an optional description below the upstream row without re-indenting it.
          if (!keyDescription) {
            return row;
          }
          return (
